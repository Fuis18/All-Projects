...
let network = new brain.NeuralNetwork({
   ...
   // hiddenLayers: [24,24,24,24,24,24]
   // [3] inicial
...
network.train([
   ...
   learningRate: 0.5, // Tasa de aprendizaje
   errorThresh: 0.0005, // Umbral de error para detener el entrenamiento
   // iterations: 500000, // Número de iteraciones/épocas de entrenamiento
   log: true, // Mostrar información de entrenamiento en la consola
   logPeriod: 2000 // Mostrar información de entrenamiento cada 10 iteraciones
});
